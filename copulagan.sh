...
# python3 train.py --model 'copulagan' --dataset 'Data/breast.csv' --target_col_ix 10 --k 3 --num_obs 100 --epochs 200

# python3 train.py --model 'copulagan' --dataset 'Data/post_operative.csv' --target_col_ix 8 --k 6 --num_obs 100 --epochs 200



# python3 train.py --model 'copulagan' --dataset 'Data/community_crime.csv' --target_col_ix 123 --ml_utility regression --k 5 --num_obs 10 --epochs 200
...
# python3 train.py --model 'copulagan' --dataset 'Data/parkinsons.csv' --target_col_ix 23 --ml_utility regression --k 3 --num_obs 100 --epochs 200
...
# python3 train.py --model 'copulagan' --dataset 'Data/bioconcentration.csv' --target_col_ix 13 --ml_utility regression --k 3 --num_obs 100 --epochs 200
